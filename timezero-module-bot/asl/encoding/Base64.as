...
class asl.encoding.Base64 {
	...
	*/
	...
	/**
	* Encodes a base64 string from array of bytes.
	*/
	public static function encodeBytes(src : Array):String {
		var i:Number = 0;
	...
	*/
	public static function decodeBytes(src : String) : Array {
		var i:Number = 0;
